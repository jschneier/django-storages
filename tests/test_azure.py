...
class AzureStorageTest(TestCase):
    ...
    def test_url_unsafe_chars(self):
        ...
        self.assertEqual(
            self.storage.url("foo;?:@=&\"<>#%{}|^~[]`bar/~!*()'"), "ret_foo"
        )
    ...
    def test_url_expire(self):
        ...
        self.storage._custom_service.generate_blob_shared_access_signature.return_value = (
            "foo_token"
        )
        self.storage._custom_service.make_blob_url.return_value = "ret_foo"
    ...
    def test_blob_service_default_params(self):
        ...
        with mock.patch(
            "storages.backends.azure_storage.BlockBlobService", autospec=True
        ) as c_mocked:
    ...
    def test_delete_blob(self):
        ...
        self.storage._service.delete_blob.assert_called_once_with(
            container_name=self.container_name, blob_name="name", timeout=20
        )
