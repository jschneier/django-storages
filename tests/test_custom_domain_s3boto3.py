...
from storages.backends import custom_domain_s3boto3
...
class CustomDomainSignedS3Boto3TestCase(TestCase):
    def setUp(self):
        self.storage = custom_domain_s3boto3.CustomDomainSignedS3Boto3Storage()
        self.storage._connections.connection = mock.MagicMock()


class CustomDomainSignedS3Boto3StorageTests(CustomDomainSignedS3Boto3TestCase):
