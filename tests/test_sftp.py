...
class SFTPStorageTest(TestCase):
    def setUp(self):
        self.storage = sftp.SFTPStorage('foo')
    ...
    def test_open(self):
        ...
        self.assertIsInstance(file_, sftp.SFTPStorageFile)

    @patch('storages.backends.sftp.SFTPStorage.sftp')
...
class SFTPStorageFileTest(TestCase):
    def setUp(self):
        self.storage = sftp.SFTPStorage('foo')
        self.file = sftp.SFTPStorageFile('bar', self.storage, 'wb')
