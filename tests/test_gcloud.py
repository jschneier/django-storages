...
class GCloudStorageTests(GCloudTestCase):
    ...
    def test_modified_time(self):
        ...
        self.assertEqual(self.storage._modified_time(self.filename), aware_date)
    ...
    def test_created_time(self):
        ...
        self.assertEqual(self.storage._created_time(self.filename), aware_date)

    def test_modified_time_no_file(self):
        self.storage._bucket = mock.MagicMock()
        self.storage._bucket.get_blob.return_value = None

        self.assertRaises(NotFound, self.storage._modified_time, self.filename)
