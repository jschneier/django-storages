...
class S3Boto3StorageTests(S3Boto3TestCase):
    ...
    def test_storage_save(self):
        ...
        obj.upload_fileobj.assert_called_with(
            content, ExtraArgs={"ContentType": "text/plain"}
        )
    ...
    def test_content_type(self):
        ...
        obj = self.storage.bucket.Object.return_value
        obj.upload_fileobj.assert_called_with(
            content, ExtraArgs={"ContentType": "image/jpeg"}
        )
    ...
    def test_storage_save_gzip(self):
        ...
        obj = self.storage.bucket.Object.return_value
        obj.upload_fileobj.assert_called_with(
            mock.ANY, ExtraArgs={"ContentType": "text/css", "ContentEncoding": "gzip"}
        )
    ...
    def test_storage_listdir_subdir(self):
        ...
        pages = [
            {
                "CommonPrefixes": [{"Prefix": "some/path"}],
                "Contents": [{"Key": "some/2.txt"}],
            },
        ]
    ...
    def test_storage_url_custom_domain_signed_urls(self):
        ...
        signed_url = (
            url
            + "?Expires=3600&Signature=DbqVgh3FHtttQxof214tSAVE8Nqn3Q4Ii7eR3iykbOqAPbV89HC3EB~0CWxarpLNtbfosS5LxiP5EutriM7E8uR4Gm~UVY-PFUjPcwqdnmAiKJF0EVs7koJcMR8MKDStuWfFKVUPJ8H7ORYTOrixyHBV2NOrpI6SN5UX6ctNM50_&Key-Pair-Id=test-key"  # noqa: E501
        )
